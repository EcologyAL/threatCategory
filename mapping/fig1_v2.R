...
p
ggsave('outputs/fig1/figure1a.jpg',width = 7,height = 1.3)
ggsave('outputs/fig1/figure1a.pdf',width = 7,height = 1.3)

#p <- p1+p2+p3+plot_layout(ncol=1,heights = c(0.7,0.6,3.5))
p3
ggsave('outputs/fig1/figure1c.jpg',width = 7,height = 3.5)
ggsave('outputs/fig1/figure1c.pdf',width = 7,height = 3.5)

p.fa
ggsave('outputs/fig1/figure1b.jpg',width = 7,height = 1.6)
ggsave('outputs/fig1/figure1b.pdf',width = 7,height = 1.6)
