...
{
  cairo_ps('outputs/fig2/fig2a_Ensem.ps',width=2,height=2,pointsize=6)
...
# {
#   cairo_ps('outputs/fig2/fig2a_Ensem.ps',width=3 ,height=3)
#   #jpeg('outputs/fig2a_noEnsem.jpg',width=3.6,height=3.6,units = 'in',res=300)
#   circos.par(start.degree = 0)
#   chordDiagram(red.list.cp,big.gap = 15,
#                annotationTrack = c('name','grid'),
...
p
ggsave('outputs/fig2/figure2c_em.pdf',width = 6,height = 3)
ggsave('outputs/fig2/figure2c_em.jpg',width = 6,height = 3,dpi=300)
...
#labs(title='(c) RLI anomaly')
p
ggsave('outputs/fig2/figure2b.pdf',width = 4,height = 2)
ggsave('outputs/fig2/figure2b.jpg',width = 4,height = 2,dpi=300)
